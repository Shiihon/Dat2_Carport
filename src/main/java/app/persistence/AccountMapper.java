...
public class AccountMapper {
    ...
    public Account login(String email, String password, ConnectionPool connectionPool) throws DatabaseException {
        String sql = "SELECT account_id, account_role, account_first_name, account_last_name, account_address, account_zip, city, account_phone_number " +
                "FROM accounts INNER JOIN postal_code ON account_zip = zip " +
